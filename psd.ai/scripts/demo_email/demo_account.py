#!/usr/bin/env python3
"""Create/remove the switchable 'Demo' EmailAccount in psd.ai.

Mirrors the existing local-Dovecot account (localhost:31143, STARTTLS) but points
at the throwaway demo@psd_ai.local mailbox. Password is stored Fernet-encrypted
