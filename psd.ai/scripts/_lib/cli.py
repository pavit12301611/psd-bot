"""scripts/_lib/cli.py — shared scaffolding for the `psd_ai-*` CLIs.
...
parents-parser pattern. Usage:
    ...
    def build_parser():
        p = common_parser("psd_ai-foo", "Description.")
...
# Make repo root importable. Tools are invoked as `scripts/psd_ai-foo`
...
VERSION = "0.1.0"  # bumped centrally; every psd_ai-* CLI reports this
