...
- [ ] I searched [open issues](https://github.com/pavit12301611/psd-bot/issues) and [open PRs](https://github.com/pavit12301611/psd-bot/pulls) — this is not a duplicate.
- [ ] This PR targets `dev`
...
- [ ] **Style match**: the change uses psd.ai's existing visual language. Specifically:
