...
COPILOT_USER_AGENT = os.environ.get(
    "PSD_AI_COPILOT_USER_AGENT", "psd.ai/1.0"
)
COPILOT_INTEGRATION_ID = os.environ.get(
    "PSD_AI_COPILOT_INTEGRATION_ID", "vscode-chat"
)
COPILOT_EDITOR_VERSION = os.environ.get(
    "PSD_AI_COPILOT_EDITOR_VERSION", "psd.ai/1.0"
)
