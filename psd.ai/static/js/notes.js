...
let _searchQuery = '';
let _viewMode = (typeof localStorage !== 'undefined' && localStorage.getItem('psd_ai-notes-view')) || 'list'; // 'list' or 'grid'
...
const REMINDER_FIRED_KEY = 'psd_ai-notes-reminder-fired';
...
const REMINDER_GLOWED_KEY = 'psd_ai-notes-reminder-glowed';
...
const REMINDER_PENDING_HIGHLIGHT_KEY = 'psd_ai-notes-reminder-pending-highlight';
const REMINDER_ACTIVE_HIGHLIGHT_KEY = 'psd_ai-notes-reminder-active-highlight';
...
const REMINDER_DISMISSED_AT_KEY = 'psd_ai-notes-reminder-dismissed-at';
const NOTES_FIRST_OPEN_HINT_KEY = 'psd_ai-notes-first-open-hint-v1';
...
function _bringNotesToFront(pane = document.getElementById('notes-pane')) {
  ...
  try {
    window.dispatchEvent(new CustomEvent('psd_ai:modal-opened', {
...
export function openPanel() {
  ...
  if (viewBtn) {
    ...
    viewBtn.addEventListener('click', () => {
      ...
      try { localStorage.setItem('psd_ai-notes-view', _viewMode); } catch {}
      pane.classList.toggle('notes-view-grid', _viewMode === 'grid');
      _setViewLabel();
      requestAnimationFrame(() => _applyMasonry(document.querySelector('#notes-pane .notes-pane-body')));
    });
...
const _DRAFT_PREFIX = 'psd_ai-note-draft-';
