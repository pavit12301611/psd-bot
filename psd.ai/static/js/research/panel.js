...
const _RESEARCH_HINTS = [
  "e.g. Trace psd.ai's ten-year journey home from Troy — every island, monster, and detour, and why each one cost him",
...
const _SETTINGS_KEY = 'psd_ai-research-settings';
const _COLLAPSE_KEY = 'psd_ai-research-settings-collapsed';
...
function _wireEvents(pane) {
  ...
  pane.querySelector('#research-settings-toggle').addEventListener('click', () => {
    ...
    try { localStorage.setItem('psd_ai-research-settings-collapsed', _settingsCollapsed ? '1' : '0'); } catch {}
  });
