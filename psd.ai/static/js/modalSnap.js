...
const EMAIL_DOC_SPLIT_WIDTH_KEY = 'psd_ai-email-doc-split-width';
const EDGE_DOCK_WIDTH_KEY_PREFIX = 'psd_ai-edge-dock-width';
...
(function _initEdgeDockResizeHandles() {
  ...
  window.addEventListener('psd_ai:modal-opened', _positionEdgeDockResizeHandles);
  _positionEdgeDockResizeHandles();
})();
