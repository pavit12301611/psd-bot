...
const LS_KEY = 'psd_ai-theme';
const CUSTOM_THEMES_KEY = 'psd_ai-custom-themes';
...
const ADV_KEYS = [
  ...
  { key: 'brandColor',         css: '--brand-color',       label: 'psd.ai Logo',    group: 'Sidebar' },
...
const UI_SCALE_KEY = 'psd_ai-ui-scale';
...
export function initThemeUI() {
  ...
  if (exportBtnEl) {
    ...
    newExp.addEventListener('click', () => {
      ...
      a.href = url;
      a.download = 'psd_ai_' + (obj.name || 'theme') + '.json';
      a.click();
