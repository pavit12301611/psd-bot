"""`psd_ai-research list --status complete` was returning nothing.
...
Part of #2122 (psd_ai-* CLI list/search bugs).
"""
...
def _load_cli():
    ...
    loader = importlib.machinery.SourceFileLoader("psd_ai_research_cli", str(path))
