"""cmd_add (scripts/psd_ai-memory) must tolerate a non-dict row in the
...
def _load_cli(monkeypatch):
    ...
    path = ROOT / "scripts" / "psd_ai-memory"
    loader = importlib.machinery.SourceFileLoader("psd_ai_memory_cli_add", str(path))
