...
```text
[order-report] working directory: /path/to/psd_ai
...
[order-report] reproduce with: /path/to/psd_ai/venv/bin/python /path/to/psd_ai/tests/run_order_report.py --seed 284734921 -- tests/cli/ -q
```
