...
Imports MemoryManager and MemoryVectorStore from the psd.ai codebase.
"""
...
_OWNER_ENV_KEYS = ("PSD_AI_MCP_MEMORY_OWNER", "PSD_AI_MEMORY_OWNER")
_OWNER_SCOPE_ERROR = (
    "Error: Memory MCP owner is not configured for an owner-scoped memory store. "
    "Set PSD_AI_MCP_MEMORY_OWNER for this server or use the owner-aware native memory tool."
)
